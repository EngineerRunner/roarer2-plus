            ...
            <Popover.Root>
              ...
              <Popover.Portal>
                <Popover.Content asChild align="end" sideOffset={4}>
                  <div className="z-[--z-above-sidebar] flex w-68 flex-row flex-wrap gap-2 rounded-lg border border-gray-200 bg-white px-2 py-1 dark:border-gray-800 dark:bg-gray-950">
